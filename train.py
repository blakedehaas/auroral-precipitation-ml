...
dataset = datasets.load_from_disk("data/auroral_precipitation_dataset_temporal")
...
if not os.path.exists(f'data/{model_name}_norm_stats.json'):
    # Calculate mean and std for the specified columns across combined dataset
    means, stds = utils.calculate_stats(train_df, columns_to_normalize, list_columns=["AL_index", "SYM_H", "f107_index"])
